        ...
        <AnimatePresence initial={false} custom={direction} mode="popLayout">
          ...
          >
            ...
            <a
              ...
              className="mt-6 xl:mt-0 w-full rounded-sm px-6 py-3 text-center text-xs font-bold uppercase tracking-[0.15em] !bg-[var(--color-ink)] !text-[var(--color-bg-main)] btn-primary hover:bg-[var(--color-accent)] hover:text-[var(--color-bg-main)] transition-colors"
            >
